...
OPCODE_METADATA: tuple[OpcodeMetadata, ...] = (
    OpcodeMetadata(int(OpcodeId.IO_WRITE), "IO_WRITE", WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.IO_READ_WRITE), "IO_READ_WRITE", READ_WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.MEM_WRITE), "MEM_WRITE", WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.MEM_READ_WRITE), "MEM_READ_WRITE", READ_WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.PCI_CONFIG_WRITE), "PCI_CONFIG_WRITE", WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.PCI_CONFIG_READ_WRITE), "PCI_CONFIG_READ_WRITE", READ_WRITE_FIELDS),
    OpcodeMetadata(int(OpcodeId.SMBUS_EXECUTE), "SMBUS_EXECUTE", SMBUS_FIELDS),
    OpcodeMetadata(int(OpcodeId.STALL), "STALL", STALL_FIELDS),
    OpcodeMetadata(int(OpcodeId.DISPATCH), "DISPATCH", DISPATCH_FIELDS),
    OpcodeMetadata(int(OpcodeId.DISPATCH_2), "DISPATCH_2", DISPATCH_2_FIELDS),
    OpcodeMetadata(int(OpcodeId.INFORMATION), "INFORMATION", INFORMATION_FIELDS),
    OpcodeMetadata(int(OpcodeId.PCI_CONFIG2_WRITE), "PCI_CONFIG2_WRITE", SEGMENTED_WRITE_FIELDS),
    OpcodeMetadata(
        int(OpcodeId.PCI_CONFIG2_READ_WRITE),
        "PCI_CONFIG2_READ_WRITE",
        SEGMENTED_READ_WRITE_FIELDS,
    ),
    OpcodeMetadata(int(OpcodeId.IO_POLL), "IO_POLL", POLL_FIELDS),
    OpcodeMetadata(int(OpcodeId.MEM_POLL), "MEM_POLL", MEM_POLL_FIELDS),
    OpcodeMetadata(int(OpcodeId.PCI_CONFIG_POLL), "PCI_CONFIG_POLL", POLL_FIELDS),
    OpcodeMetadata(int(OpcodeId.PCI_CONFIG2_POLL), "PCI_CONFIG2_POLL", SEGMENTED_POLL_FIELDS),
    OpcodeMetadata(int(OpcodeId.TERMINATE), "TERMINATE", EMPTY_FIELDS),
)
